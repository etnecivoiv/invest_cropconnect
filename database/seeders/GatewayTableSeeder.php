    ...
    public function run()
    {
         $gateways = [
            [
                'id' => '1',
                'name' => 'paypal',
                'logo' => '/demo/payment-gateway/paypal.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '2',
            ...
            [
                'id' => '2',
                'name' => 'stripe',
                'logo' => '/demo/payment-gateway/stripe.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '2',
            ...
            [
                'id' => '3',
                'name' => 'mollie',
                'logo' => '/demo/payment-gateway/mollie.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '2',
            ...
            [
                'id' => '4',
                'name' => 'paystack',
                'logo' => '/demo/payment-gateway/paystack.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '2',
            ...
            [
                'id' => '5',
                'name' => 'razorpay',
                'logo' => '/demo/payment-gateway/rajorpay.png',
                'min_amount' => 1,
                'max_amount' => 10000,
                'charge' => '2',
            ...
            [
                'id' => '6',
                'name' => 'instamojo',
                'logo' => '/demo/payment-gateway/instamojo.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '2',
            ...
            [
                'id' => '7',
                'name' => 'toyyibpay',
                'logo' => '/demo/payment-gateway/toyybipay.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '2',
            ...
            [
                'id' => '8',
                'name' => 'flutterwave',
                'logo' => '/demo/payment-gateway/flutterwave.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '2',
            ...
            [
                'id' => '9',
                'name' => 'payu',
                'logo' => '/demo/payment-gateway/payu.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '2',
            ...
            [
                'id' => '10',
                'name' => 'thawani',
                'logo' => '/demo/payment-gateway/uhawan.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '1',
            ...
            [
                ...
                'logo' => '/demo/payment-gateway/mercado-pago.png',
                'min_amount' => 1,
                'max_amount' => 1000,
                'charge' => '2',
