    ...
    public function rules(): array
    {
        ...
        if ($step == 4) {
            return [
                ...
                'education_qualifications.*.result' => ['required_if:education_qualifications.*.is_current,false', 'max:5.00'],
                'education_qualifications.*.start_at' => ['required', 'max_digits:4'],
                'education_qualifications.*.pass_year' => ['required_if:education_qualifications.*.is_current,false', 'max_digits:4'],
            ];
        }
        if ($step == 5) {
            return [
                'resume' => ['nullable', File::types(['jpg', 'jpeg', 'png', 'pdf', 'doc', 'docx'])->max(5000)],
            ];
        }
        return [];
    }
